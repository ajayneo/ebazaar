...
class MB_AdminMoney_Model_Method_Checkmo extends Mage_Payment_Model_Method_Checkmo
{
    ...
    public function assignData($data)
    {
		...
		$details['bank_name'] = $data->getBankName();
		$details['bank_branch_name'] = $data->getBankBranchName();
		$details['cheque_no'] = $data->getChequeNo();

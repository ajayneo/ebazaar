    ...
    protected function writeOrder($order, $fp)
    {
        ...
        foreach ($orderItems as $item)
        {
            ...
            if (!$item->isDummy()) {
                ...
                $newRecord[2] = $record[61];
                $newRecord[3] = $record[28];
                $newRecord[4] = $record[19];
                $newRecord[5] = $record[62];
                $newRecord[6] = $record[56];
                $newRecord[7] = $record[55];
                $newRecord[8] = $record[54];
                $newRecord[9] = $record[56];
                $newRecord[10] = $record[4];
                $newRecord[11] = '';
                $newRecord[12] = $record[18];
                $newRecord[13] = '';
                $newRecord[14] = $record[28];
                $newRecord[15] = $record[30];

                $newRecord[16] = $record[27];

                $newRecord[17] = '';
                $newRecord[18] = '';
                $newRecord[19] = ''; 

                $newRecord[20] = $record[49];
                ...
                fputcsv($fp, $newRecord, self::DELIMITER, self::ENCLOSURE);
            } 
        }
    }

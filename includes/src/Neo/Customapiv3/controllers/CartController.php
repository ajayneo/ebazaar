<?php
	class Neo_Customapiv3_CartController extends Neo_Customapiv3_Controller_HttpAuthController
	{
		    	...
		    	try {
		    		...
		    		if(!empty($customerId)) {
		    			// get customer model
							...
							if(empty($quoteId)){
								$quote_id = Mage::getModel('customapiv3/customer')->createQuoteAndAssignCustomer($customer_model_eb);
							}
		    		} else {

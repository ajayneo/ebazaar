<?php
	class Neo_Customapiv2_CartController extends Neo_Customapiv2_Controller_HttpAuthController
	{
		    	...
		    	try {
		    		...
		    		if(!empty($customerId)) {
		    			// get customer model
							...
							if(empty($quoteId)){
								$quote_id = Mage::getModel('customapiv2/customer')->createQuoteAndAssignCustomer($customer_model_eb);
							}
		    		} else {

<?php
	class Neo_Customapiv5_CartController extends Neo_Customapiv5_Controller_HttpAuthController
	{
		    	...
		    	try {
		    		...
		    		if(!empty($customerId)) {
		    			// get customer model
							...
							if(empty($quoteId)){
								$quote_id = Mage::getModel('customapiv5/customer')->createQuoteAndAssignCustomer($customer_model_eb);
							}
		    		} else {

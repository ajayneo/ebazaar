...
class Neo_Feedback_Adminhtml_FeedbackController extends Mage_Adminhtml_Controller_action
{
    ...
    */
    ...
    public function exportCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('feedback/adminhtml_feedback_grid')
            ->getCsv();

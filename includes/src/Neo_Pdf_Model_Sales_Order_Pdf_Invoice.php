    ...
    public function getPdf($invoices = array())
    {
        ...
        foreach ($invoices as $invoice) {
           ...
           $stockLocationModelRaw = Mage::getModel('stocklocation/location');
            ...
            if($stockLocationModel['stock_location']=='Kurla Warehouse' || $stockLocationModel['stock_location']=='Bhiwandi Warehouse' ||$stockLocationModel['stock_location']=='Andheri HO'){
                $page->drawText("VAT TIN NOV # 27530926734V,CST NO # 27530926734C,Service Tax #: AAKC A6979MSD003", 136, $this->y, 'UTF-8');
            }elseif($stockLocationModel['stock_location']=='Bangalore YCH HUB' || $stockLocationModel['stock_location']== 'Bangalore Proconnect HUB'){

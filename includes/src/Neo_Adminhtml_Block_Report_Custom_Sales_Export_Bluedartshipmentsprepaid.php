 ...
 */
class Neo_Adminhtml_Block_Report_Custom_Sales_Export_Bluedartshipmentsprepaid extends Mage_Adminhtml_Block_Widget_Grid
{	
   public function __construct()
	...
	{		
		...
		$collection->getSelect()
			...
			"shipment_track.parent_id = main_table.entity_id AND shipment_track.carrier_code IN ('bluedart_ecomprepaid')", 

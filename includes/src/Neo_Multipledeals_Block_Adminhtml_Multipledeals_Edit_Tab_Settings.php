...
class Neo_Multipledeals_Block_Adminhtml_Multipledeals_Edit_Tab_Settings extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
		...
		$field = $fieldset->addField('deal_mrpprice', 'text', array(
            'label'     => Mage::helper('multipledeals')->__('Deal MRP Price'),
            'name'      => 'deal_mrpprice',
            'class'     => 'required-entry',
            'required'  => true,
        ));

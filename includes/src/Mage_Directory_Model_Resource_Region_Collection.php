...
class Mage_Directory_Model_Resource_Region_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    protected function _initSelect()
    {
        ...
        $this->getSelect()->joinLeft(
            ...
            array('name'))->where('main_table.region_id in (485,486,487,488,489,490,491,492,493,494,495,496,497,498,499,500,501,
            502,503,504,505,506,507,508,509,510,511,512,513,514,515,516,517,518,519,520,555)');

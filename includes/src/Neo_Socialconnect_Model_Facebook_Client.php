...
class Neo_Socialconnect_Model_Facebook_Client extends Inchoo_SocialConnect_Model_Facebook_Client
{
    ...
    public function __construct($params = array())
    {
        if(($this->isEnabled = $this->_isEnabled())) {
			...
			#echo self::REDIRECT_URI_ROUTE;
			#echo Mage::getUrl(self::REDIRECT_URI_ROUTE);

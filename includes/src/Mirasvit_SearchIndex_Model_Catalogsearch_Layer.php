...
class Mirasvit_SearchIndex_Model_Catalogsearch_Layer extends Mirasvit_SearchIndex_Model_Catalogsearch_Layer_Extends
{
    public function prepareProductCollection($collection)
    {
        ...
        /* added by pradeep sanku on 3rd June 2015 as a part of moving the outofstock product to end of list in the search */
        $websiteId = Mage::app()->getStore()->getWebsiteId();
        if (Mage::helper('catalog')->isModuleEnabled('Mage_CatalogInventory')) {
            $collection->joinTable(
                array('stock_status' => 'cataloginventory/stock_status'),

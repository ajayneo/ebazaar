...
$saltval = 'bg@#8&';
*/
$merchantId = $merchantid = '652564864653642';
$subMerchantId = $submerchantid = 'eb12';
$saltval = 'ez$!)%1';
       ...
       Mage::log('checksum string '.$checksum_string,null,'innoviti_request.log');
       $chksum =  MD5($checksum_string);
        ...
        Mage::log('request',null,'innoviti_request.log',true);
        Mage::log($form->toHtml(),null,'innoviti_request.log',true);

...
JsCountdown.prototype = {
	...
	updateCounter: function(){
		this.calculate();
		this.formatTime();
		//this.countainer.innerHTML = "<div class=\"js-countdown" + (this.days > 0? "-days" : "") + "\" style=\"color:" + this.textColor + "\">" + (this.days > 0? "<strong>" + this.days + "</strong> " + this.daysText : "") + " <strong>" + this.hours + "</strong>:<strong>" + this.minutes + "</strong>:<strong>" + this.seconds + "</strong></div>";
		this.countainer.innerHTML = "<div class=\"js-countdown" + (this.days > 0? "-days" : "") + "\" style=\"color:" + this.textColor + "\"><ul>" + (this.days > 0? "<li><strong>" + this.days + "</strong><span>Days</span></li> " : "") + " <li><strong>" + this.hours + "</strong><span>Hours</span></li><li><strong>" + this.minutes + "</strong><span>Minutes</span></li><li><strong>" + this.seconds + "</strong><span>Seconds</span></li></ul></div>";

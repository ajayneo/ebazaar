        ...
        return a("html").addClass("sfi-js"), this.each(function() {
            ...
            if (d.onInit(), !a(this).next(".sfi-wrapper").length) {
                ...
                h.unbind("click").bind("click", function(a) {
                    ...
                    _val = a(this).val(), 1 == k(_val) ? (g.text(i(_val)), d.onFileSelect(), f.removeClass(d.errorClass), f.addClass(d.validClass)) : (d.onError(), e.val(""), f.removeClass(d.validClass), f.addClass(d.errorClass), e.parent().find('.validation-advice').toggle())
                })
            }
        })
    }

...
// Added by Dnyaneshwar Jambhulkar
    // To hide the menu content on when click anywhere on html page
    //start
    $j(document).on('scroll',function(e) {
        ...
        nav.find('li').removeClass('sub-menu-active');
    });
    ...
    // Start
    nav.find('a.level0').on(pointerEvent,function (event) {
        nav.find('li').removeClass('menu-active');
        nav.find('li').removeClass('sub-menu-active');
    });
    //end

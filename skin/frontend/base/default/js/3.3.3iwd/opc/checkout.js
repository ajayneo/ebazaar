...
IWD.OPC.Billing = {
		...
		initChangeAddress: function(){
			...
			$j('#opc-address-form-billing input').blur(function(){
				if(IWD.OPC.Billing.pradeepForm()){
		...
		pradeepForm:function(){
			//var valueCountry = $j('#billing-new-address-form select[name="billing[country_id]"]').val();
			var firstname = $j('input[name="billing[firstname]"]').val();
			var lastname = $j('input[name="billing[lastname]"]').val();
			var email = $j('input[name="billing[email]"]').val();
			var address = $j('input[name="billing[street][]"]').val();
			var bcountry = $j('select[name="billing[country_id]"]').val();
			var bstate = $j('select[name="billing[region_id]"]').val();
			var bcity = $j('input[name="billing[city]"]').val();
			var bpostcode = $j('input[name="billing[postcode]"]').val();
			var btelephone = $j('input[name="billing[telephone]"]').val();
			if(firstname != '' && lastname != '' && email != '' && address != '' && bcountry != '' && bstate != '' && bcity != '' && bpostcode != '' && btelephone !=''){
				return true;
			}else{
				return false;
			}
...
IWD.OPC.Shipping = {
		...
		initChangeAddress: function(){
			...
			$j('#opc-address-form-shipping input').blur(function(){
				if(IWD.OPC.Shipping.pradeepShippingForm()){
					console.log(IWD.OPC.Shipping.pradeepShippingForm());
		...
		pradeepShippingForm:function(){
			var firstname = $j('input[name="shipping[firstname]"]').val();
			var lastname = $j('input[name="shipping[lastname]"]').val();
			var address = $j('input[name="shipping[street][]"]').val();
			var scountry = $j('select[name="shipping[country_id]"]').val();
			var sstate = $j('select[name="shipping[region_id]"]').val();
			var scity = $j('input[name="shipping[city]"]').val();
			var spostcode = $j('input[name="shipping[postcode]"]').val();
			var stelephone = $j('input[name="shipping[telephone]"]').val();
			if(firstname != '' && lastname != '' && address != '' && scountry != '' && sstate != '' && scity != '' && spostcode != '' && stelephone !=''){
				return true;
			}else{
				return false;
			}

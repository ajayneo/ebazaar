...
class Magestore_Bannerslider_Adminhtml_BannersliderController extends Mage_Adminhtml_Controller_Action {
    ...
    /**
     * mass change preferences of item(s) action
     */
    ...
    public function changePreferencesAction() {
        $sliderId = $this->getRequest()->getParam('id');
            try {
            	Mage::getModel('bannerslider/bannerslider')->changePreferences($sliderId);
                
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('adminhtml')->__('Preferences of Banners are successfully changed.'));
            } catch (Exception $e) {
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
            }

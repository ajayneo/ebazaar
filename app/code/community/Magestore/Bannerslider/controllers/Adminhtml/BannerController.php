...
class Magestore_Bannerslider_Adminhtml_BannerController extends Mage_Adminhtml_Controller_Action {
    ...
    protected function _isAllowed() {
    	return true; // added this and commented below line since it was not working check later (access to bharti the manage banner menu)
    ...
    public function changePreferencesAction() {
        ...
        Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('adminhtml')->__('Cache flushed successfully.'));

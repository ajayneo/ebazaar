...
class Magestore_Bannerslider_Block_Adminhtml_Bannerslider_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareColumns(){
		...
		$this->addColumn('similar_to', array(
			'header'	=> Mage::helper('bannerslider')->__('Similar To'),
			'align'	 =>'left',
			'filter' => false,
			'index'	 => 'similar_to',
			'type'	=> 'options',
		...
		$this->addColumn('action',
			array(
				...
				'actions'	=> array(
					...
					array(
						'caption'	=> Mage::helper('bannerslider')->__('Change Preferences'),
						'url'		=> array('base'=> '*/*/changePreferences'),
						'field'		=> 'id'
					)),
				'filter'	=> false,
				'sortable'	=> false,

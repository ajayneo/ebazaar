...
class Magestore_Bannerslider_Block_Adminhtml_Banner_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
       ...
       // $collection->getSelect()->joinLeft(array('table_alias' => $collection->getTable('bannerslider/bannerslider')), 'main_table.bannerslider_id = table_alias.bannerslider_id', array('bannerslider_title' => 'table_alias.title','slider_id' => 'table_alias.bannerslider_id'));
    ...
    protected function _prepareColumns() {
        ...
        $bannerSliders = Mage::getModel('bannerslider/bannerslider')->getCollection();
        $bannerSlidersOptions = array();
        foreach ($bannerSliders as $bannerSlider) {
            $bannerSlidersOptions[$bannerSlider->getBannersliderId()] = $bannerSlider->getTitle();
        }
        ...
        $this->addColumn('bannerslider_id', array(
            ...
            'align' => 'left',
            'type' => 'options',
            'filter_index' => 'bannerslider_id',
            'index' => 'bannerslider_id',
            'options'=> $bannerSlidersOptions
        ));
...
*/
        ...
        $this->addColumn('preference', array(
           'header' => Mage::helper('bannerslider')->__('Preference'),
           'align' => 'left',
           'index' => 'preference',
       ));

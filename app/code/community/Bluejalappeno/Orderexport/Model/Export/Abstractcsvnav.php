 ...
 * */
abstract class Bluejalappeno_Orderexport_Model_Export_Abstractcsvnav extends Mage_Core_Model_Abstract
{
    /**
     ...
     */
    abstract public function exportOrders($orders,$from,$to);

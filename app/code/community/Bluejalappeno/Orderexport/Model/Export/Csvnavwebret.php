 ...
 * */ 
class Bluejalappeno_Orderexport_Model_Export_Csvnavwebret extends Bluejalappeno_Orderexport_Model_Export_Abstractcsvnav
{
    const ENCLOSURE = '"';
    const DELIMITER = ',';
    ...
    {    
        ...
        $fp = fopen(Mage::getBaseDir().'/kaw17842knlpREGdasp9045/navision/export/return'.'/'.$fileName, 'w');

 ...
 */
class Creatuitycorp_Shareyourpurchase_Block_Social_Button_Pinterest_Script extends Mage_Core_Block_Template {

    const XPATH_ENABLE_AGGREGATE_PURCHASE = 'shareyourpurchase/pinterest_aggregate_purchase/enable';
    const XPATH_ENABLE_ONE_PRODUCT_PURCHASE = 'shareyourpurchase/pinterest_one_product/enable';
    ...
    protected function _construct() {
        if (Mage::getStoreConfig(Creatuitycorp_Shareyourpurchase_Block_Social_Wrapper_Abstract::XPATH_ENABLE)
            ...
            $this->setTemplate('shareyourpurchase/pinterest/script.phtml');
        }
    }

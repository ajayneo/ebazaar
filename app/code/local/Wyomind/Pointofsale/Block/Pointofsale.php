...
class Wyomind_Pointofsale_Block_Pointofsale extends Mage_Core_Block_Template {
    ...
    public function getPointofsale() {
        ...
        $collection = Mage::getModel('pointofsale/pointofsale')
                        ->getPlacesByStoreId(Mage::app()->getStore()->getStoreId())->addFieldToFilter('status', Array('status' => 1))->setOrder('`order`', 'ASC');
        return $collection;
    }

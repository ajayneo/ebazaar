...
class Mage_Payment_Block_Info_Banktransfer extends Mage_Payment_Block_Info
{
    ...
    public function getPaymentInfo(){
         return $collectionDelivery = Mage::getModel("banktransferdelivery/delivery")->getCollection()->addFieldToSelect('delivery')->addFieldToFilter('order_num',$this->getRequest()->getParam('order_id'))->getFirstItem()->getData();
    }
}

...
class Mage_SalesRule_Model_Rule_Condition_Address extends Mage_Rule_Model_Condition_Abstract
{
    ...
    public function validate(Varien_Object $object)
    {
        ...
        //Mahesh Gurav 06 Jan 2018
        //changes for discount based on grand total
        if ('payment_method' == $this->getAttribute() && ! $address->hasPaymentMethod()) {
            $address->setPaymentMethod($object->getQuote()->getPayment()->getMethod());
        }

        //this changes are for applying discount based on grand total
        ...
        //this changes required to correct double grand total issue
        $validate = parent::validate($address); 

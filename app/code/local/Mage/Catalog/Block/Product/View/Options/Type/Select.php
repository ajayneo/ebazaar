    ...
    public function getValuesHtml()
    {
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN
            ...
            $select = $this->getLayout()->createBlock('core/html_select')
                ->setData(array(
                    ...
                    'class' => $require.' product-custom-option'.' '.strtolower($_option->getTitle())
                ));
            if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN) {
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_RADIO
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                //$selectHtml .= '</li><p>'.$_value->getSku().'</p>';
                $selectHtml .='</li>';
                if($_value->getTitle() == 'Good'){
                $selectHtml .= '<p>Like new (powers on, no missing keys, no scratches, dents or cracks)</p>'; 
                }else if($_value->getTitle() == 'Fair'){
                $selectHtml .= '<p>Signs of normal use (powers on, some scratches but no dents or cracks, no missing keys)</p>'; 
                }else if($_value->getTitle() == 'Poor'){
                $selectHtml .= '<p>Powers on but has significant scratches, dents, cracked casing, and/or missing keys</p>'; 
                }else if($_value->getTitle() == 'IMEI'){
                $selectHtml .= '<p>Powers on but has significant scratches, dents, cracked casing, and/or missing keys</p>'; 
                }else{
                    //$selectHtml .='<p></p>';
                }

...
class Mage_Catalog_Block_Product_View extends Mage_Catalog_Block_Product_Abstract
{
    ...
    * @purpose : To check pincode is serviceable or not
    */
    public function getProductDeliveryOnDetailsPage($pincode = NULL){   
        return Mage::getModel('operations/serviceablepincodes')->getProductDeliveryOnDetailsPage($pincode);
    }
    
    /*
    * @author : SOnali Kosrabe
    * @date : 29th Mar 2018
    * @purpose : To get product sold qty
    */
    public function getProductSoldQty($product){
        return Mage::getModel('catalog/productinfo')->getProductSoldQty($product);
    }
}

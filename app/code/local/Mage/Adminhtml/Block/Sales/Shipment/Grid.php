...
<<<<<<< HEAD
        $collection->join(array('track'=>'sales/shipment_track'),'main_table.entity_id = track.parent_id',array('track_number','title','carrier_code'));
=======
        $collection->join(array('track'=>'sales/shipment_track'),'main_table.entity_id = track.parent_id',array('track_number','title'));
>>>>>>> 9e335ce29d74d14a7b69fc748139fd4153ceef99
...
<<<<<<< HEAD
        $this->addColumn('carrier_code', array(
            'header' => Mage::helper('sales')->__('Carrier Code'),
            'index' => 'carrier_code',
        ));
...
>>>>>>> 9e335ce29d74d14a7b69fc748139fd4153ceef99
        $this->addColumn('track_number', array(
            'header' => Mage::helper('sales')->__('AWB Number'),
            'index' => 'track_number',
        ));
<<<<<<< HEAD

...
class Mage_Adminhtml_Block_Widget_Grid_Container extends Mage_Adminhtml_Block_Widget_Container
{
    ...
    {
        $grid_block = $this->getLayout()->createBlock( $this->_blockGroup.'/' . $this->_controller . '_grid', $this->_controller . '.grid');
        if($grid_block){
            $this->setChild( 'grid', $grid_block->setSaveParametersInSession(true));
        }

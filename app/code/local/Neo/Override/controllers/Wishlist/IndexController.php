...
class Neo_Override_Wishlist_IndexController extends Mage_Wishlist_IndexController{
    ...
    * @date : 03-04-2018
    * @purpose : To skip coming soon product while add to all cart wishlist
    */
    public function allcartAction()
    {
        ...
        foreach ($collection as $item) {
            ...
            if($item->getProduct()->getNewLaunch()){
                continue; /// Skipping coming soon product while add to cart
            }
            try {

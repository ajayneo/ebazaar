...
class Neo_Suvidha_Block_Adminhtml_Creditsuvidha_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
		...
		protected function _prepareColumns()
		{
				...
				'header' => Mage::helper('suvidha')->__('Status'),
				'index' => 'status',
				'type' => 'options',
				'options'=>Neo_Suvidha_Block_Adminhtml_Creditsuvidha_Grid::getOptionArrayStatus(),				
				));
				$this->addColumn('form_status', array(
				'header' => Mage::helper('suvidha')->__('Form Status'),
				'index' => 'form_status',
				'type' => 'options',
				'options'=>Neo_Suvidha_Block_Adminhtml_Creditsuvidha_Grid::getOptionArrayFormStatus(),				
				));
				$this->addColumn('created_at', array(
				'header'    => Mage::helper('suvidha')->__('Created At'),
				'index'     => 'created_at',
				'type'      => 'datetime',
				));
				$this->addColumn('updated_at', array(
				'header'    => Mage::helper('suvidha')->__('Updated At'),
				'index'     => 'updated_at',
				'type'      => 'datetime',
				));
				...
				$this->addColumn("crm_name", array(
				"header" => Mage::helper("suvidha")->__("CRM"),
				"index" => "crm_name",
				));
				...
				$this->addColumn("assigned_credit_limit", array(
				"header" => Mage::helper("suvidha")->__("Assigned Credit Limit"),
				"index" => "assigned_credit_limit",
				));
				$this->addColumn('mapped_status', array(
				'header' => Mage::helper('suvidha')->__('Mapped Status'),
				'index' => 'mapped_status',
				'type' => 'options',
				'options'=>Neo_Suvidha_Block_Adminhtml_Creditsuvidha_Grid::getOptionArrayMapped(),				
				));
		...
		{
            $data_array=array(); 
			$data_array[0]='In Process';
			$data_array[1]='Approved';
			$data_array[2]='Rejected';
			$data_array[3]='Pending';
            return($data_array);
		}
		static public function getValueArrayStatus()
		{
            $data_array=array();
			foreach(Neo_Suvidha_Block_Adminhtml_Creditsuvidha_Grid::getOptionArrayStatus() as $k=>$v){
               $data_array[]=array('value'=>$k,'label'=>$v);		
			}
            return($data_array);
		...
		static public function getOptionArrayMapped()
		{
            $data_array=array(); 
			$data_array[0]='No';
			$data_array[1]='Yes';
		...
		static public function getValueArrayMapped()
		{
            $data_array=array();
			foreach(Neo_Suvidha_Block_Adminhtml_Creditsuvidha_Grid::getOptionArrayMapped() as $k=>$v){
               $data_array[]=array('value'=>$k,'label'=>$v);		
			}
            return($data_array);
		...
		static public function getOptionArrayFormStatus()
		{
            $data_array=array(); 
			$data_array[0] = 'Not Submitted';
			$data_array[1] = 'Submitted';
            return($data_array);
		}
		static public function getValueArrayFormStatus()
		{
            $data_array=array();
			foreach(Neo_Suvidha_Block_Adminhtml_Creditsuvidha_Grid::getOptionArrayFormStatus() as $k=>$v){
               $data_array[]=array('value'=>$k,'label'=>$v);		
			}
            return($data_array);

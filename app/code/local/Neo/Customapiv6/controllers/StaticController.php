<?php
	class Neo_Customapiv6_StaticController extends Mage_Core_Controller_Front_Action
	{
    ...
    */
    ...
    public function getAndroidAppVersionAction()
    {
      $ver['appversion'] = 72;
      echo json_encode(array('status' => 1, 'data' => $ver));
    }

    public function getIphoneAppVersionAction()
    {
      // $ver['appversion'] = 1.15;
      $ver['appversion'] = 3.0;
      echo json_encode(array('status' => 1, 'data' => $ver));

 ...
 */
class Neo_Notification_Model_Resource_Pushnotificationtest_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    {
        parent::_construct();
        $this->_init('neo_notification/pushnotificationtest');
    }

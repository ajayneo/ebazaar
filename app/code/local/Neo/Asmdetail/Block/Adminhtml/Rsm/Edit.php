...
class Neo_Asmdetail_Block_Adminhtml_Rsm_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		{
				if( Mage::registry("rsm_data") && Mage::registry("rsm_data")->getId() ){

				    return Mage::helper("asmdetail")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("rsm_data")->getId()));

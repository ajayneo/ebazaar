<?php
class Neo_Shippinge_Model_Fedex_Shipmentovr extends Neo_Shippinge_Model_Fedex
{	
...
Mage::log($response,null,'bhargav.log',true);
    ...
    protected function getProperty($var){
        ...
        if($var == 'shipaccount') Return Mage::getStoreConfig('shipping/fedex/shipaccount2');
        if($var == 'billaccount') Return Mage::getStoreConfig('shipping/fedex/shipaccount2');
        if($var == 'dutyaccount') Return Mage::getStoreConfig('shipping/fedex/shipaccount2');
        if($var == 'freightaccount') Return Mage::getStoreConfig('shipping/fedex/shipaccount2');
        if($var == 'trackaccount') Return Mage::getStoreConfig('shipping/fedex/shipaccount2');
        if($var == 'dutiesaccount') Return Mage::getStoreConfig('shipping/fedex/shipaccount2');
        if($var == 'importeraccount') Return Mage::getStoreConfig('shipping/fedex/shipaccount2');
        if($var == 'brokeraccount') Return Mage::getStoreConfig('shipping/fedex/shipaccount2');
        if($var == 'distributionaccount') Return Mage::getStoreConfig('shipping/fedex/shipaccount2');

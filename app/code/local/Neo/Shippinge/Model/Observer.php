...
class Neo_Shippinge_Model_Observer
{
	...
	public function sales_order_save_before($observer)
	{
		...
		if($order->getCustomerEmail() == '' || $order->getCustomerGroupId() == 1)
		{
		  Mage::throwException('You cannot proceed without email address or only Affiliate user allowed to place order.');
		}		
	}
}
?>

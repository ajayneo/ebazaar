...
class Neo_Orderreturn_IndexController extends Mage_Core_Controller_Front_Action{
    ...
    public function submitAction()
    {
      ...
      $savedata['reason'] = json_encode($reason);
        ...
        //changes on 25th Jan 2018 For making shipping address as pickup address
        ...
        $address = $order->getShippingAddress()->getData();
          ...
          $pickup_address = $name.", ".$street.", ".$city.", POSTCODE: ".$postcode.", ".$region;

        if(strlen($pickup_address) > 0){

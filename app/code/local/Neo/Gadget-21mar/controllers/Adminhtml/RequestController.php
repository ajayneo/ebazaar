		...
		public function massExportAction() 
		{
			try {
					...
					foreach ($ids as $id) {
						  ...
						  $new = json_decode($model->getOptions());
						  $fullArray = $this->array_insert($model->getData(),$new,'option');
					...
					//=================
					  	$this->array_to_csv_download(
					  		...
					  		$newArray
					  		, 
							  "export_gadget_buy_request_".date("Y/m/d").'_'.date("h:i:sa").".csv" 
							);
				    //=================

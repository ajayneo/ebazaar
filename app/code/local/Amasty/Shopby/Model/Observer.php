    ...
    public function handleBlockOutput($observer)
    {
        ...
        if ($block instanceof Mage_Catalog_Block_Category_View || $block instanceof Mage_CatalogSearch_Block_Result) {
            ...
            if (strpos($html, "amshopby-page-container") === FALSE){
                ...
                if(is_object($currentCategory) && $currentCategory->getUrlPath() == 'microsoft-products'){
                    $html = '<div class="amshopby-page-container microsoft-container" id="amshopby-page-container">' .
                            $html .

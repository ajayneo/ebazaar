...
//query for orders
$query = "SELECT o.increment_id as 'order_id', i.sku, i.name, o.customer_firstname as 'cust_name', c0.city as 'City', c0.region as 'State', c0.parent_id as 'parent_id' , o.customer_email, i.row_total_incl_tax as amount_total, i.qty_ordered as qty, i.base_discount_amount as discount, i.row_total_incl_tax-i.base_discount_amount as net_sale, c1.category_id as Openbox, c2.category_id as New, c3.category_id as Preowned, c4.category_id as Accessories, c5.category_id as 'asismobiles', c6.category_id as 'refurbishedlaptops', c7.category_id as 'featurephones', c8.category_id as 'tablets', p.method FROM sales_flat_order as o 
...
if($results){
	...
	foreach($results as $key => $o){
		...
		if($count == 0 && $last_order_id == 0){
			// fputcsv($fp, array('Order Id','SKU','Product Name','Store Name','Amount Total','Qty','Discount','Net Sale','Category','City','State','ASM Name','RSM Name','Payment Method'));
...
if (($handle = fopen($file_path, "r")) !== FALSE) {
    ...
    while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
        ...
        if($row !== 1){
        	// print_r($data); exit;
        	$temp[strtolower($data[8]).'_partner'][] = $data[14];
...
// echo "<pre>";
$cat_array = array('openbox','new','preowned','accessories','refurbishedlaptops','asismobiles','featurephones','tablets');
...
if($current_hour < 23){
$reciepient = array('akhilesh@electronicsbazaar.com','kushlesh@electronicsbazaar.com','rajkumarvarma@kaykay.co.in','amritpalsingh.d@electronicsbazaar.com','anil.w@kaykay.co.in','web.maheshgurav@gmail.com','rsm@electronicsbazaar.com','prakash@kaykay.co.in','ketaki@electronicsbazaar.com','nabajyoti.b@electronicsbazaar.com','yash.r@electronicsbazaar.com','keval@electronicsbazaar.com','santosh@kaykay.co.in','george.v@electronicsbazaar.com','hari@electronicsbazaar.com','mayur.m@electronicsbazaar.com','syed.s@electronicsbazaar.com','royas@kaykay.co.in','kunal.d@electronicsbazaar.com','n.praveen@electronicsbazaar.com','mangesh.r@electronicsbazaar.com','sonalik2788@gmail.com','sujay.k@electronicsbazaar.com','mamata.s@electronicsbazaar.com','mayur.m@electronicsbazaar.com','syed.s@electronicsbazaar.com','rohtas.k@electronicsbazaar.com','mayur.p@electronicsbazaar.com','vineeta.y@electronicsbazaar.com');
}else{
	
$reciepient = array('akhilesh@electronicsbazaar.com','kushlesh@electronicsbazaar.com','rajkumarvarma@kaykay.co.in','sharad@compuindia.com','amritpalsingh.d@electronicsbazaar.com','anil.w@kaykay.co.in','web.maheshgurav@gmail.com','rsm@electronicsbazaar.com','prakash@kaykay.co.in','ketaki@electronicsbazaar.com','nabajyoti.b@electronicsbazaar.com','yash.r@electronicsbazaar.com','keval@electronicsbazaar.com','santosh@kaykay.co.in','george.v@electronicsbazaar.com','hari@electronicsbazaar.com','mayur.m@electronicsbazaar.com','syed.s@electronicsbazaar.com','royas@kaykay.co.in','kunal.d@electronicsbazaar.com','n.praveen@electronicsbazaar.com','mangesh.r@electronicsbazaar.com','sonalik2788@gmail.com','sujay.k@electronicsbazaar.com','mamata.s@electronicsbazaar.com','mayur.m@electronicsbazaar.com','syed.s@electronicsbazaar.com','rohtas.k@electronicsbazaar.com','mayur.p@electronicsbazaar.com','vineeta.y@electronicsbazaar.com');
}
...
try {
    ...
    $z_mail->send();
    Mage::log("Ordersummary v2 email sent ",null,"customexport.log",true);
} catch (Exception $e) {
	Mage::log("Ordersummary v2 email error ".$e->getMessage(),null,"customexport.log",true);
}

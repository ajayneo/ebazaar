...
//query for orders
//$query = "SELECT o.increment_id as 'order_id', i.sku, i.name, o.customer_firstname as 'cust_name', o.customer_email, i.row_total_incl_tax as total, i.qty_ordered as qty, c1.category_id as Openbox, c2.category_id as New, c3.category_id as Preowned, c4.category_id as Accessories, c5.category_id as 'Brand_Refurbished', c0.city as 'city' FROM sales_flat_order as o 
